...
export default function Level300Page() {
  ...
  const allEbooks = useMemo(() => {
    const free = freeEbooks ? freeEbooks.map(e => ({ ...e, collection: 'materials_300lvl_free' })) : [];
    const prem = premiumEbooks ? premiumEbooks.map(e => ({ ...e, collection: 'materials_300lvl_premium' })) : [];
