...
export default function Level200Page() {
  ...
  const allEbooks = useMemo(() => {
    const free = freeEbooks ? freeEbooks.map(e => ({ ...e, collection: 'materials_200lvl_free' })) : [];
    const prem = premiumEbooks ? premiumEbooks.map(e => ({ ...e, collection: 'materials_200lvl_premium' })) : [];
  ...
  return (
    <div className="space-y-8 pb-12">
      <div className="text-center space-y-2">
        <h1 className="text-4xl font-bold tracking-tight">200-Level Study Hub</h1>
        <p className="text-muted-foreground text-lg">Advanced materials for medical and health sciences students.</p>
      </div>
